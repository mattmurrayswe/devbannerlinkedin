            ...
            <div class="h-5/6 my-20">
                <div class="w-full h-[295px] bg-black flex flex-col justify-between my-10">
                    ...
                    <div id="tecs" class="flex justify-end self-end w-full">
                        <img class="m-6" src="{{URL::asset('/image/aws.png')}}" alt="profile Pic" width="120">
                        <img class="m-6" src="{{URL::asset('/image/javascript.png')}}" alt="profile Pic" width="120">
                        <img class="m-6" src="{{URL::asset('/image/vue.png')}}" alt="profile Pic" width="120">
                        <img class="m-6" src="{{URL::asset('/image/docker.png')}}" alt="profile Pic" width="120">
                    </div>
                </div>
                ...
                <input id="email" value="cainandropa1301@outlook.com" class="mb-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
v                   <option value="azure">Azure</option>
                    <option selected value="aws">AWS</option>
